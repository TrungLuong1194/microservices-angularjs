...
app.config(function ($routeProvider) {
    ...
    $routeProvider.when('/comments', {
        templateUrl: 'html/comment/commentsList.html',
        controller: 'CommentCtrl'
    }).when('/addComment', {
        templateUrl: 'html/comment/addComment.html',
        controller: 'CommentCtrl'
    }).when('/editComment/:commentId', {
        templateUrl: 'html/comment/editComment.html',
        controller: 'CommentCtrl'
    }).when('/deleteComment/:commentId', {
        templateUrl: 'html/comment/deleteComment.html',
        controller: 'CommentCtrl'
    }).when('/students/:studentId', {
        templateUrl: 'html/comment/commentsListByStudentID.html',
        controller: 'CommentCtrl'
    }).when('/posts/:postId', {
        templateUrl: 'html/comment/commentsListByPostID.html',
        controller: 'CommentCtrl'
    }).otherwise({
        redirectTo: '/comments'
    });
