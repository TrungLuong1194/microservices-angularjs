...
app.config(function ($routeProvider) {
    ...
    $routeProvider.
    when('/students', {
        templateUrl: 'html/student/studentsList.html',
        controller: 'StudentCtrl',
    }).
    when('/addStudent', {
        templateUrl: 'html/student/addStudent.html',
        controller: 'StudentCtrl'
    }).
    when('/editStudent/:studentId', {
        templateUrl: 'html/student/editStudent.html',
        controller: 'StudentCtrl'
    }).
    when('/deleteStudent/:studentId', {
        templateUrl: 'html/student/deleteStudent.html',
        controller: 'StudentCtrl'
    }).
    otherwise({
        redirectTo: '/students'
