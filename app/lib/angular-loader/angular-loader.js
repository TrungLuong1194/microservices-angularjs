 ...
 *
 * var exampleMinErr = minErr('city');
 * throw exampleMinErr('one', 'This {0} is {1}', foo, bar);
 *
 * The above creates an instance of minErr in the city namespace. The
 * resulting error will have a namespaced error code of city.one.  The
    ...
    return function module(name, requires, configFn) {
      ...
      return ensure(modules, name, function() {
        ...
        var moduleInstance = {
           ...
           * For city you could put the version of the module in here.
           *
           * ```js
